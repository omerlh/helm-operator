...
import (
	...
	appv1alpha1 "github.com/omerlh/helm-operator/pkg/apis/app/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &corev1.Secret{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &appv1alpha1.HelmRelease{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileHelmRelease) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set HelmRelease instance as the owner and controller
...
func newPodForCR(cr *appv1alpha1.HelmRelease) *corev1.Pod {
